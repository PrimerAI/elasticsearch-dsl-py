...
from elasticsearch_legacy.helpers.test import get_test_client, SkipTest
from elasticsearch_legacy.helpers import bulk
...
def client(request):
    ...
    from elasticsearch_dsl_legacy.connections import connections
