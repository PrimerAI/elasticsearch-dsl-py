...
from elasticsearch_dsl_legacy.faceted_search import FacetedSearch, TermsFacet, DateHistogramFacet, RangeFacet
...
def test_empty_search_finds_everything(data_client):
    ...
    assert [
        ('elasticsearch_dsl_legacy', 40, False),
        ('test_elasticsearch_dsl_legacy', 35, False),
        ('elasticsearch_dsl_legacy/query.py', 19, False),
        ('test_elasticsearch_dsl_legacy/test_search.py', 15, False),
        ('elasticsearch_dsl_legacy/utils.py', 14, False),
        ('test_elasticsearch_dsl_legacy/test_query.py', 13, False),
        ('elasticsearch_dsl_legacy/search.py', 12, False),
        ('elasticsearch_dsl_legacy/aggs.py', 11, False),
        ('test_elasticsearch_dsl_legacy/test_result.py', 5, False),
        ('elasticsearch_dsl_legacy/result.py', 3, False)
    ] == r.facets.files
...
def test_term_filters_are_shown_as_selected_and_data_is_filtered(data_client):
    cs = CommitSearch(filters={'files': 'test_elasticsearch_dsl_legacy'})
    ...
    assert [
        ('elasticsearch_dsl_legacy', 40, False),
        ('test_elasticsearch_dsl_legacy', 35, True), # selected
        ('elasticsearch_dsl_legacy/query.py', 19, False),
        ('test_elasticsearch_dsl_legacy/test_search.py', 15, False),
        ('elasticsearch_dsl_legacy/utils.py', 14, False),
        ('test_elasticsearch_dsl_legacy/test_query.py', 13, False),
